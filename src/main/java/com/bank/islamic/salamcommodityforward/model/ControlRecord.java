package com.bank.islamic.salamcommodityforward.model;
...
/**
 * The BIAN control record for this service domain: "Salam Contract Fulfillment Arrangement".
 *
 ...
 * to its asset type (Salam Contract). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Salam Contract Fulfillment Arrangement";
